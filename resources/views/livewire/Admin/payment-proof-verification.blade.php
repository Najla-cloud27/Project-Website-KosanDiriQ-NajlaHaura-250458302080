        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: calc(100vh - 200px); overflow-y: auto;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="border p-2 text-center bg-light" style="min-height: 300px;">
                                    @if($selectedProof->proof_image_url)
                                        ...
                                        <small class="d-block text-muted mt-2">Klik gambar untuk memperbesar</small>
                                    @else
                    ...
                    @if($selectedProof->status == 'menunggu')
                    <hr>
                    <div class="form-group">
                    ...
                    @elseif($selectedProof->admin_notes)
                    <hr>
