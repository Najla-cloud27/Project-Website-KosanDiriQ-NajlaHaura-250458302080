                                ...
                                @php
                                    ...
                                    foreach($latestBookings as $booking) {
                                        $activities->push([
                                            'type' => 'Booking',
                                            'badge' => 'info',
                                            'detail' => ($booking->booking_code ?? 'N/A') . ' - ' . ($booking->user->name ?? 'Unknown') . ' - ' . ($booking->room->room_number ?? 'N/A'),
                                    ...
                                    foreach($latestComplaints as $complaint) {
                                        $activities->push([
                                            'type' => 'Keluhan',
                                            'badge' => 'warning',
                                            'detail' => Str::limit($complaint->title ?? 'N/A', 50) . ' - ' . ($complaint->user->name ?? 'Unknown'),
