                            ...
                            <tbody>
                                @forelse($recentComplaints as $complaint)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('penyewa.complaints.index') }}" class="btn btn-sm btn-primary" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-3">Tidak ada keluhan</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
