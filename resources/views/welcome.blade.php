    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ route('home') }}">
                <i class="fas fa-home me-2"></i>KosanDiriQ
            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <h5 class="fw-bold mb-3"><i class="fas fa-home me-2"></i>KosanDiriQ</h5>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p><i class="fas fa-envelope me-2"></i>info@KosanDiriQ.com</p>
                    <p><i class="fas fa-phone me-2"></i>+62 851-8287-9771</p>
                    <div class="mt-3">
            ...
            <div class="text-center">
                <p class="mb-0">&copy; {{ date('Y') }} KosanDiriQ. All rights reserved.</p>
            </div>
        </div>
    </footer>
