...
class AnnouncementManagement extends Component
{
    ...
    public function updateAnnouncement()
    {
        ...
        if ($this->image) {
            ...
            if ($announcement->image_url && \Illuminate\Support\Facades\Storage::disk('public')->exists($announcement->image_url)) {
                \Illuminate\Support\Facades\Storage::disk('public')->delete($announcement->image_url);
            }
